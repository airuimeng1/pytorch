...
mxfp8_grouped_mm_skip_msg = "MXFP8 grouped GEMM is only supported on Nvidia SM100+ or AMD GPUs that support MXFP8 when PyTorch is built with USE_FBGEMM_GENAI=1"
