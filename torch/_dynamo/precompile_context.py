...
class PrecompileContext:
    ...
    _backend_artifacts_by_key: dict[str, BackendCacheArtifact[object]] = {}
    ...
    def record_artifact(
        cls,
        artifact: BackendCacheArtifact[object],
    ) -> None:
        """
    ...
    @classmethod
    def serialize_artifact_by_key(
        cls, key: str
    ) -> Optional[BackendCacheArtifact[object]]:
        """
    ...
    def dump_debug_info(
        ...
        backend_artifacts: dict[str, BackendCacheArtifact[object]],
    ) -> dict[str, Any]:
        """
    ...
    def create_cache_entries(
        ...
        for key, cache_entry in dynamo_entries.items():
            try:
                ...
                backend_content: dict[_BackendId, BackendCacheArtifact[object]] = {}
                for id_ in backends:
