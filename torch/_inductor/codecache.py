...
"""
        ...
        with lock:
            ...
            compile_command: dict[str, Any] = {
                ...
                "use_relative_path": use_relative_path,
                "vec_isa": picked_vec_isa,
                "include_pytorch": not config.aot_inductor.compile_standalone or config.test_configs.use_libtorch,
            }
            ...
            if config.aot_inductor.package_cpp_only:
                ...
                if is_target_windows() and config.aot_inductor.dynamic_linkage:
                    with open(
                        os.path.join(
                            os.path.dirname(os.path.dirname(__file__)),
                            "csrc",
